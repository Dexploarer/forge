...
export class AISDKService {
   ...
   * Uses AI Gateway for multimodal image generation
   */
  async generateImage(
    description: string,
    assetType: string,
    ...
    try {
      console.log('[AISDKService] Using AI Gateway for image generation')

      // Use generateText with AI Gateway multimodal model
